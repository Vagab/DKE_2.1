...
public class AIHeuristics6Players implements AIMultiPlayer{
    ...
    public AIHeuristics6Players(double distanceFromMiddleWeight, double distanceToGoalWeight, double radiusWeight, Color colorAI) {
    ...
    public double[] evaluationFunction(GraphOscar graph) {
        double[] evaluationValues = {-1000, -1000, -1000, -1000, -1000, -1000};
        ...
        double evaluationValueRed = -distanceToGoalWeight * distanceToGoalRed
                    - distanceFromMiddleWeight * distanceFromMiddleRed
                    - radiusWeight * radiusRed;
        ...
        evaluationValues[1] = evaluationValueGray;
        evaluationValues[2] = evaluationValueOrange;
        evaluationValues[3] = evaluationValueRed;
        evaluationValues[4] = evaluationValueBlack;
        evaluationValues[5] = evaluationValueGreen;
        return evaluationValues;
    }
...
//            System.out.println("At depth " + depth + " the evaluation values are: " + Arrays.toString(evaluationFunction(board)));
        ...
        ArrayList<Integer> armyOpponent4 = board.getArmy(getNextColor(color,3));
        ArrayList<Integer> armyOpponent5 = board.getArmy(getNextColor(color,4));
        double[] evaluationValues = new double[6];
...
//            System.out.println(integerToNode(armyState,board));
            GraphOscar graphChild = new GraphOscar(6,armyState, armyOpponent1, armyOpponent2, armyOpponent3, armyOpponent4, armyOpponent5,
                    color, getNextColor(color,0), getNextColor(color,1), getNextColor(color,2), getNextColor(color,3),
                    getNextColor(color,4));
