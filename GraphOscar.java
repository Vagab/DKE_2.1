...
public class GraphOscar {
    ...
    private void makeNodes(){
        ...
        AA = new Node("AA",0,0); //AA

        BA = new Node("BA",1,0); //AB
        BB = new Node("BB",1,1); //BB

        CA = new Node("CA",2,0); //CA
        CB = new Node("CB",2,1); //CB
        CC = new Node("CC",2,2); //CC

        DA = new Node("DA",3,0); //DA
        DB = new Node("DB",3,1); //DB
        DC = new Node("DC",3,2); //DC
        DD = new Node("DD",3,3); //DD

        E4 = new Node("E4",4, -4); //E4
        E3 = new Node("E3",4, -3); //E3
        E2 = new Node("E2",4, -2); //E2
        E1 = new Node("E1",4, -1); //E1
        EA = new Node("EA",4,0); //EA
        EB = new Node("EB",4,1); //EB
        EC = new Node("EC",4,2); //EC
        ED = new Node("ED",4,3); //ED
        EE = new Node("EE",4,4); //EE
        EF = new Node("EF",4, 5); //EF
        EG = new Node("EG",4, 6); //EG
        EH = new Node("EH",4, 7); //EH
        EI = new Node("EI",4, 8); //EI

        F3 = new Node("F3",5, -3); //F3
        F2 = new Node("F2",5, -2); //F2
        F1 = new Node("F1",5, -1); //F1
        FA = new Node("FA",5,0); //FA
        FB = new Node("FB",5,1); //FB
        FC = new Node("FC",5,2); //FC
        FD = new Node("FD",5,3); //FD
        FE = new Node("FE",5,4); //FE
        FF = new Node("FF",5,5); //FF
        FG = new Node("FG",5, 6); //FG
        FH = new Node("FH",5, 7); //FH
        FI = new Node("FI",5, 8); //FI

        G2 = new Node("G2",6,-2); //G2
        G1 = new Node("G1",6,-1); //G1
        GA = new Node("GA",6,0); //GA
        GB = new Node("GB",6,1); //GB
        GC = new Node("GC",6,2); //GC
        GD = new Node("GD",6,3); //GD
        GE = new Node("GE",6,4); //GE
        GF = new Node("GF",6,5); //GF
        GG = new Node("GG",6,6); //GG
        GH = new Node("GH",6,7); //GH
        GI = new Node("GI",6,8); //GI

        H1 = new Node("H1",7, -1); //H1
        HA = new Node("HA",7,0); //HA
        HB = new Node("HB",7,1); //HB
        HC = new Node("HC",7,2); //HC
        HD = new Node("HD",7,3); //HD
        HE = new Node("HE",7,4); //HE
        HF = new Node("HF",7,5); //HF
        HG = new Node("HG",7,6); //HG
        HH = new Node("HH",7,7); //HH
        HI = new Node("HI",7,8); //HI

        IA = new Node("IA",8,0); //IA
        IB = new Node("IB",8,1); //IB
        IC = new Node("IC",8,2); //IC
        ID = new Node("ID",8,3); //ID
        IE = new Node("IE",8,4); //IE
        IF = new Node("IF",8,5); //IF
        IG = new Node("IG",8,6); //IG
        IH = new Node("IH",8,7); //IH
        II = new Node("II",8,8); //II

        J1 = new Node("J1",9, 0); //J1
        JA = new Node("JA",9,1); //JA
        JB = new Node("JB",9,2); //JB
        JC = new Node("JC",9,3); //JC
        JD = new Node("JD",9,4); //JD
        JE = new Node("JE",9,5); //JE
        JF = new Node("JF",9,6); //JF
        JG = new Node("JG",9,7); //JG
        JH = new Node("JH",9,8); //JH
        JI = new Node("JI",9,9); //JI
        ...
        LF = new Node("LF",11,8);
        LG = new Node("LG",11,9);
        LH = new Node("LH",11,10);
        LI = new Node("LI",11,11);
        ...
        ME = new Node("ME",12,8);
        MF = new Node("MF",12,9);
        MG = new Node("MG",12,10);
        MH = new Node("MH",12,11);
        MI = new Node("MI",12,12);
