...
public class GUI6players extends JComponent {
    ...
    public boolean isWinningCondition(int currentPlayer) {
        ...
        if (currentPlayer == 4) {       //checking for red
            ...
            for (int i = 0; i < 4; i++) {
                if (!board.getNodeColor(19 + i).equals(Color.BLACK))
                    return false;
            }
            for (int i = 0; i < 3; i++) {
                if (!board.getNodeColor(32 + i).equals(Color.BLACK))
                    return false;
            }
            for (int i = 0; i < 2; i++) {
                if (!board.getNodeColor(44 + i).equals(Color.BLACK))
                    return false;
            }
            if (!board.getNodeColor(55).equals(Color.BLACK))
                return false;
            ...
            return true;
                ...
                for (int i = 0; i < 4; i++) {
                    if (!board.getNodeColor(107 + i).equals(Color.GREEN))
                        return false;
                }
                for (int i = 0; i < 3; i++) {
                    if (!board.getNodeColor(95 + i).equals(Color.GREEN))
                        return false;
                }
                for (int i = 0; i < 2; i++) {
                    if (!board.getNodeColor(84 + i).equals(Color.GREEN))
                        return false;
                }
                if (!board.getNodeColor(74).equals(Color.GREEN))
                    return false;
            ...
            for (int i = 0; i < 4; i++) {
                if (!board.getNodeColor(98 + i).equals(Color.GRAY))
                    return false;
            }
            for (int i = 0; i < 3; i++) {
                if (!board.getNodeColor(86 + i).equals(Color.GRAY))
                    return false;
            }
            for (int i = 0; i < 2; i++) {
                if (!board.getNodeColor(75 + i).equals(Color.GRAY))
                    return false;
            }
            if (!board.getNodeColor(65).equals(Color.GRAY))
                return false;
            ...
            for (int i = 0; i < 4; i++) {
                if (!board.getNodeColor(10 + i).equals(Color.ORANGE))
                    return false;
            }
            for (int i = 0; i < 3; i++) {
                if (!board.getNodeColor(23 + i).equals(Color.ORANGE))
                    return false;
            }
            for (int i = 0; i < 2; i++) {
                if (!board.getNodeColor(35 + i).equals(Color.ORANGE))
                    return false;
            }
            if (!board.getNodeColor(46).equals(Color.ORANGE))
                return false;
