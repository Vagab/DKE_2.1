...
public class Graph {
    ...
    private static void makeNodes(){
        ...
        MA = new Node("MA",12,4,15);
        MB = new Node("MB",12,5,17);
        MC = new Node("MC",12,6,18);
        MD = new Node("MD",12,7,17);
        ME = new Node("ME",12,8,15);
        MF = new Node("M4",12,9,0);
        MG = new Node("M3",12,10,0);
        MH = new Node("M2",12,11,0);
        MI = new Node("M1",12,12,0);

        NA = new Node("NA",13,5,18);
        NB = new Node("NB",13,6,20);
        NC = new Node("NB",13,7,20);
        ND = new Node("NB",13,8,18);

        OA = new Node("OA",14,6,100);
        OB = new Node("OB",14,7,300);
